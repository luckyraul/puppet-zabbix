...
class zabbix (
    ...
    $server_package_name   = $zabbix::params::server_package_name,
    $server_service_ensure = $zabbix::params::server_service_ensure,
    $server_service_enable = $zabbix::params::server_service_enable,
    $server                = '127.0.0.1',
